...
*/
var aa=__webpack_require__(1),l=__webpack_require__(11),B=__webpack_require__(6),C=__webpack_require__(4),ba=__webpack_require__(12),da=__webpack_require__(13),ea=__webpack_require__(14),fa=__webpack_require__(15),ia=__webpack_require__(16),D=__webpack_require__(7);
...
var contatoIds = 0;
var mensagemIds = 0;
var contato_reducer = function contato_reducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    var action = arguments[1];
...
var mensagem_reducer = function mensagem_reducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    var action = arguments[1];
...
var toggle_reducer = function toggle_reducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { form: false, mensagens: false };
    var action = arguments[1];
...
var Mensagens = function (_Component) {
    ...
    function Mensagens() {
        ...
        return _possibleConstructorReturn(this, (Mensagens.__proto__ || Object.getPrototypeOf(Mensagens)).apply(this, arguments));
    }
    ...
    _createClass(Mensagens, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'App-mensagens' },
                _react2.default.createElement(MensagemHeader, { contato: this.props.contato }),
                this.props.mensagens.map(function (mensagem, i) {
                    return _react2.default.createElement(Mensagem, { mensagem: mensagem, key: i });
                }),
                _react2.default.createElement(
                    'div',
                    { className: 'Mensagens-form' },
                    _react2.default.createElement('input', { type: 'text', placeholder: 'Escreva sua mensagem', ref: function ref(input) {
                            _this2.input = input;
                        } }),
                    _react2.default.createElement(
                        'button',
                        { onClick: function onClick() {
                                _Store.Store.dispatch({
                                    type: 'ADD_MENSAGEM',
                                    contato: _this2.props.contato.id,
                                    descricao: _this2.input.value
                                });
                                _this2.input.value = '';
                            } },
                        '\u2714'
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./Mensagens.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./Mensagens.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', { type: 'text', placeholder: 'Jo\xE3o', ref: function ref(input) {
                                _this2.nome = input;
                            } })
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', { type: 'text', placeholder: 'Da Silva', ref: function ref(input) {
                                _this2.sobrenome = input;
                            } })
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', { type: 'email', placeholder: 'joao.da.silva@email.com.br', ref: function ref(input) {
                                _this2.email = input;
                            } })
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', { type: 'tel', placeholder: 'DDD XXXXX XXXX', ref: function ref(input) {
                                _this2.telefone = input;
                            } })
                    )
                ),
                _react2.default.createElement(
                    ...
                    { onClick: function onClick() {
                            _Store.Store.dispatch({
                                type: 'ADD_CONTATO',
                                nome: _this2.nome.value,
                                sobrenome: _this2.sobrenome.value,
                                email: _this2.email.value,
                                telefone: _this2.telefone.value
                            });
                            _this2.nome.value = '';
                            _this2.sobrenome.value = '';
                            _this2.email.value = '';
                            _this2.telefone.value = '';
                        } },
                    'Salvar'
                )
            );
